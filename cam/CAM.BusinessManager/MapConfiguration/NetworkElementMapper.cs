...
{
    public class NetworkElementMapper : Profile
    {
        private IRepositoryWrapper _repositoryWrapper;

        public NetworkElementMapper(IHttpContextAccessor contextAccessor, IEnumerable<IRepositoryWrapper> wrappers, IRepositoryWrapper repositoryWrapper)
        {
            ...
            CreateMap<NetworkElement, NetworkelementDtoGrid>()
