...
namespace CAM.BusinessManager.MapConfiguration
{
    public class IdentityMapper : Profile
    {
        ...
        public IdentityMapper(IHttpContextAccessor contextAccessor, IEnumerable<IRepositoryWrapper> wrappers, IRepositoryWrapper repositoryWrapper)
        {
           ...
           // CreateMap<NodeIdentity, IdentityDtoGrid>();
            CreateMap<NodeIdentity, IDentitiesDtoGrid>()
