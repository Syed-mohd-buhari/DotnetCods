...
{
    public class HardwareConfigurationMapper : Profile
    {
        private IRepositoryWrapper _repositoryWrapper;
        public HardwareConfigurationMapper(IHttpContextAccessor contextAccessor, IEnumerable<IRepositoryWrapper> wrappers, IRepositoryWrapper repositoryWrapper)
        {
            ...
            //CreateMap<HardwareConfiguration, HardwareConfigurationDtoGrid>();
            CreateMap<HardwareConfiguration, HardwareConfigurationDtoGrid>()
