...
{
    public class SoftwareComponentMapper : Profile
    {
        private IRepositoryWrapper _repositoryWrapper;
        public SoftwareComponentMapper(IHttpContextAccessor contextAccessor, IEnumerable<IRepositoryWrapper> wrappers, IRepositoryWrapper repositoryWrapper)
        {
            ...
            CreateMap<SoftwareComponent, SoftwareComponentsDtoGrid>();
            ...
            CreateMap<Components, SoftwareComponentsDtoGrid>()
                   .ForMember(x => x.ModificationUser, s => s.MapFrom(src => src.ModificationUserEntity.Email))
                   .ForMember(x => x.ModificationDate, s => s.MapFrom(src => src.Modificationdate))
                   .ForMember(x => x.CreationUser, s => s.MapFrom(src => src.CreationUserEntity.Email))
                   .ForMember(x => x.CreationDate, s => s.MapFrom(src => src.Creationdate));
