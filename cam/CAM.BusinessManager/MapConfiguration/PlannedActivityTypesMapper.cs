...
namespace CAM.BusinessManager.MapConfiguration
{
    ...
    public class PlannedActivityTypesMapper : Profile
    {
        private IRepositoryWrapper _repositoryWrapper;
        public PlannedActivityTypesMapper(IHttpContextAccessor contextAccessor, IEnumerable<IRepositoryWrapper> wrappers, IRepositoryWrapper repositoryWrapper)
        {
            ...
            CreateMap<PlannedActivityTypes, PlannedActivityTypesGridDto>()
      ...
      .ForMember(dest => dest.ModificationUser, opt => opt.MapFrom(src => src.ModificationUserEntity.Email))
      .ForMember(dest => dest.CreationUser, opt => opt.MapFrom(src => src.CreationUserEntity.Email));
