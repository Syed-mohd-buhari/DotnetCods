...
{
    public class AppSettingsConfigurationMapper : Profile
    {
        private IRepositoryWrapper _repositoryWrapper;
        public AppSettingsConfigurationMapper(IHttpContextAccessor contextAccessor, IEnumerable<IRepositoryWrapper> wrappers, IRepositoryWrapper repositoryWrapper)
        {
            ...
            CreateMap<AppSettingsConfiguration, AppSettingsConfigurationDto>()
