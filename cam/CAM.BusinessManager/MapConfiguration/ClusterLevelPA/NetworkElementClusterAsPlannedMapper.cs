...
{
    public class NetworkElementClusterAsPlannedMapper : Profile
    {
        private IRepositoryWrapper _repositoryWrapper;
        public NetworkElementClusterAsPlannedMapper(IHttpContextAccessor contextAccessor, IEnumerable<IRepositoryWrapper> wrappers, IRepositoryWrapper repositoryWrapper)
        {
            ...
            CreateMap<NetworkElementClusterAsPlanned, NWElementClusterAsPlannedDtoGrid>()
             .ForMember(dest => dest.LastModified, opt => opt.MapFrom(src => src.ModificationuserNavigation.Email))
