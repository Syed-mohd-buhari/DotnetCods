...
namespace CAM.Entities.Models.FNT
{
    public partial class TemsFntReport : AuditableEntity
    {
        ...
        public List<FilterValueDtoKeyValueList> verticalResponsible { get; set; }
        public List<string> verticalResponsibleCommaSeparatedList { get; set; }
