...
{
    public class IdentityQueryDto :QueryObject
    {
        public List<long> IdentitiesId { get; set; }
        ...
        public List<string> Apnodeaipaddress { get; set; }
        public List<string> Apnodebipaddress { get; set; }
