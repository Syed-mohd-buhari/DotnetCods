...
{
    public class ClusterLevelQueryDto : QueryObject
    {
        ...
        public List<string?> InfraClusterAsPlannedDeploymentStatus { get; set; }
        ...
        public DateFilter NetworkElementClusterdLastModified { get; set; }
        public List<string> NetworkElementClusterdLastModifiedBy { get; set; }
