 ...
 commit;
---- INSERT SCRIPT FOR ASPNETROLES

DROP SEQUENCE ASPNETROLESID_SEQ;
 
CREATE SEQUENCE  "ASPNETROLESID_SEQ"  MINVALUE 0 MAXVALUE 9999999999999999 
INCREMENT BY 1 START WITH  7 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;

insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('Business Continuity','BUSINESS CONTINUITY');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('DMO Delivery Tracking','DMO DELIVERY TRACKING');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('Evolution Architect','EVOLUTION ARCHITECT');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('HW Product Owner','HW PRODUCT OWNER');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('Infra Capacity Engineer','INFRA CAPACITY ENGINEER');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('Life Cycle Manager','LIFE CYCLE MANAGER');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('Life Cycle Owner','LIFE CYCLE OWNER');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('LifeCycle Owner','LIFECYCLE OWNER');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('Logical Design','LOGICAL DESIGN');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('Network Architect','NETWORK ARCHITECT');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('Network Evolution Planning','NETWORK EVOLUTION PLANNING');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('Opco E2E Network Design','OPCO E2E NETWORK DESIGN');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('Product Collection Owner','PRODUCT COLLECTION OWNER');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('SBD: Access Control','SBD: ACCESS CONTROL');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('SBD: Compliance','SBD: COMPLIANCE');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('SBD: Network Security','SBD: NETWORK SECURITY');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('SBD: Privacy','SBD: PRIVACY');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('SBD: Sec Management','SBD: SEC MANAGEMENT');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('SBD: System Security','SBD: SYSTEM SECURITY');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('SW Product Owner','SW PRODUCT OWNER');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('TEMS Functional Admin','TEMS FUNCTIONAL ADMIN');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('TEMS System Owner','TEMS SYSTEM OWNER');
insert into ASPNETROLES (NAME,NORMALIZEDNAME) values ('Test Manager','TEST MANAGER');
Commit;
