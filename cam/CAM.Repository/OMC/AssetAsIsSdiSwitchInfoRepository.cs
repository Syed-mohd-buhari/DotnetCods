...
{
    public class AssetAsIsSdiSwitchInfoRepository : RepositoryBase<Assetasissdiswitchinfo>, IAssetAsIsSdiSwitchInfoRepository
    {
        ModelContext _modelContext;
        public AssetAsIsSdiSwitchInfoRepository(ModelContext repositoryContext) : base(repositoryContext)
        {
