...
{
    public class ActivityStatusRepository : RepositoryBase<Activitystatuses>, IActivityStatusRepository
    {
        public ActivityStatusRepository(ModelContext repositoryContext) : base(repositoryContext)
        {
        }
