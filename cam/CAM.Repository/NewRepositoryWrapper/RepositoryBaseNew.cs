...
{
    public abstract class RepositoryBaseNew<T> : IRepositoryBase<T>
        where T : class
    {
        ...
        protected RepositoryContextNew RepositoryContext { get; set; }

        protected ModelContextNew ModelContext { get; set; }

        protected RepositoryBaseNew(ModelContextNew repositoryContext)
        {
        ...
        {
            //ModelContext.Set<T>().Update(entity);
