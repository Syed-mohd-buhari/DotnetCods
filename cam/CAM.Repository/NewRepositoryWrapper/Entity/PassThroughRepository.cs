...
{
    public class PassThroughRepository : RepositoryBaseNew<Assetpassthrough>, IPassThroughRepository
    {
        ModelContextNew _repositoryContext;
        public PassThroughRepository(ModelContextNew repositoryContext) : base(repositoryContext)
        {
