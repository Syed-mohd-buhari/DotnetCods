...
{
    public class DesignAspectRepository : RepositoryBase<Designaspects>, IDesignAspectRepository
    {
        ModelContext _context;
        public DesignAspectRepository(ModelContext repositoryContext) : base(repositoryContext)
        {
