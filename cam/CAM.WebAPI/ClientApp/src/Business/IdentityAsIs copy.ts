...
export const IdentityAsIsApiFetchParamCreator = function (
  ...
  return {
    ...
    // GetAssetsByOpcoIdAndProductNameId(opcoId?: number, productNameId?: number): FetchArgs {
    //   const localVarPath = `/api/IdentityAsIs/Delete`;
    //   const localVarUrlObj = url.parse(localVarPath, true);
    //   const localVarRequestOptions = Object.assign(
    //     { method: "DELETE" },
    ...
    GetAssetsByOpcoIdAndProductNameId(
      opcoId?: number,
      productNameId?: number,

      options: any = {}
    ): FetchArgs {
      const localVarPath = `/api/NetworkElementAsPlanned/GetAssetsByOpcoIdAndProductNameId`;
      const localVarUrlObj = url.parse(localVarPath, true);
      ...
      if (productNameId !== undefined) {
        localVarQueryParameter["productNameId"] = productNameId;
      }
...
export const IdentityAsIsApiFp = function (configuration?: Configuration) {
  return {
    ...
    GetAssetsByOpcoIdAndProductNameId(
      ...
      const localVarFetchArgs = IdentityAsIsApiFetchParamCreator(
        configuration
      ).GetAssetsByOpcoIdAndProductNameId(opcoId, productNameId, options);
      return (fetch: FetchAPI = isomorphicFetch, basePath = BASE_PATH) => {
        return fetch(
          basePath + localVarFetchArgs.url,
          localVarFetchArgs.options
...
export const IdentityAsIsApiFactory = function (
  ...
  return {
    ...
    GetAssetsByOpcoIdAndProductNameId(
      ...
      return IdentityAsIsApiFp(configuration).GetAssetsByOpcoIdAndProductNameId(
        opcoId,
        productNameId,
        options
      )(fetch, basePath);
...
export class IdentityAsIsApi extends BaseAPI {
   ...
   * @memberof IdentityAsIsApi
   */
  public GetAssetsByOpcoIdAndProductNameId(
    designComponentId?: number,
    options?: any
  ) {
    return IdentityAsIsApiFp(
      this.configuration
    ).GetAssetsByOpcoIdAndProductNameId(designComponentId, options)(
      this.fetch,
      this.basePath
    );
  }
