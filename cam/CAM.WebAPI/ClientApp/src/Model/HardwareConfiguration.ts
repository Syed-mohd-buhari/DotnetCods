 ...
 *
 * @export
 * @interface HardwareConfigurationDtoCreate
 */
export interface HardwareConfigurationDtoCreate extends NetworkElementAsIsDto {
  /**
   *
   * @type {number}
   * @memberof HardwareConfigurationDtoCreate
   */
 ...
 *
 * @export
 * @interface HardwareConfigurationDtoGrid
 */
export interface HardwareConfigurationDtoGrid extends NetworkElementAsIsDto {
  /**
   *
   * @type {number}
   * @memberof HardwareConfigurationDtoGrid
   */
  hardwareconfigurationid?: number;
  /**
   *
   * @type {string}
   * @memberof HardwareConfigurationDtoGrid
 ...
 *
 * @export
 * @interface HardwareConfigurationDtoUpdate
 */
export interface HardwareConfigurationDtoUpdate
  extends HardwareConfigurationDtoCreate {
  /**
   *
   * @type {number}
   * @memberof HardwareConfigurationDtoUpdate
   */
  hardwareconfigurationid?: number;
}
/**
 *
 * @export
 * @interface QueryResultDtoOfHardwareConfigurationDtoGrid
 */
export interface QueryResultDtoOfHardwareConfigurationDtoGrid {
  /**
   *
   * @type {number}
   * @memberof QueryResultDtoOfHardwareConfigurationDtoGrid
   */
  totalItems?: number;
  /**
   *
   ...
   * @memberof QueryResultDtoOfHardwareConfigurationDtoGrid
   */
  items?: Array<HardwareConfigurationDtoGrid>;
  /**
   *
   * @type {CustomGridRenderOfHardwareConfigurationDtoGrid}
   * @memberof QueryResultDtoOfHardwareConfigurationDtoGrid
   */
  gridRender?: CustomGridRenderOfHardwareConfigurationDtoGrid;
}

/**
 *
 * @export
 * @interface CustomGridRenderOfHardwareConfigurationDtoGrid
 */
export interface CustomGridRenderOfHardwareConfigurationDtoGrid {
  /**
   *
   * @type {string}
   * @memberof CustomGridRenderOfHardwareConfigurationDtoGrid
   */
  className?: string;
  /**
   *
...
export interface HardwareConfigurationQueryObjectGrid extends QueryObject {
  /**
   *
   * @type {Array<number>}
   * @memberof NetworkElementsAsIsQueryDto
   */
  hardwareconfigurationid?: Array<number>;
  /**
   *
   * @type {Array<number>}
   * @memberof NetworkElementsAsIsQueryDto
...
/**
 *
 * @param {Array<number>} [hardwareconfigurationid]
...
export interface NetworkElementAsIsEdit {
  NetworkElementAsIsDtoEdit: HardwareConfigurationDtoUpdate | null;
  ResultDtoEdit: ResultDto | null;
}

export interface NetworkElementAsIsCreate {
  HardwareConfigurationDtoCreate: HardwareConfigurationDtoCreate | null;
  ResultDtoCreate: ResultDto | null;
}

export interface NetworkElementAsIsGrid {
  NetworkElementAsIsGridResult: QueryResultDtoOfHardwareConfigurationDtoGrid | null;
  filter: FilterValueDto[] | null;
}

export interface HardwareConfigurationGrid {
  HardwareConfigurationGridResult: QueryResultDtoOfHardwareConfigurationDtoGrid | null;
  filter: FilterValueDto[] | null;
}
...
export const GET_GRID_HARDWARE_CONFIGURATION =
  "GET_GRID_HARDWARE_CONFIGURATION";
