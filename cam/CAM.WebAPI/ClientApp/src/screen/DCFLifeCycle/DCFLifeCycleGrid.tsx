...
import { GetFilterColumDCFLifeCycle } from "../../Redux/Action/DCFLifeCycle/DCFLifeCycleGridAction";
...
interface Props {
  ...
  data: DCFLifeCycleDtoGrid[] | undefined;
  pagination: DCFLifeCycleQueryObjectGrid | undefined;
  renderGrid: RenderDetail[];
  orphanColor?: boolean;
}

let firstIndex, secondIndex, thirdIndex;
const DCFLifeCycleGrid: React.FC<Props> = (props) => {
  console.log("Tems DCFLifeCycleGrid props", props);
  ...
  const getFiltersData = (state: RootState) =>
    state.dcfLifeCycleGridReducer.filter;
  ...
  const {
    ...
    isFiltriAttivati,
  } = useFilterTableCrud<DCFLifeCycleQueryObjectGrid>(
    props.action.Filter,
    GetFilterColumDCFLifeCycle,
    props.pagination
  );
...
export default DCFLifeCycleGrid;
