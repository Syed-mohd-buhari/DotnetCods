...
import { GetFilterColumPassThroughHardwareReport } from "../../Redux/Action/Report/PassThroughHardwareGridAction";
...
interface Props {
  ...
  data: PassThroughHardwareReportDtoGrid[] | undefined;
  pagination: PassThroughHardwareReportQueryObjectGrid | undefined;
  renderGrid: RenderDetail[];
}

let firstIndex, secondIndex, thirdIndex;
const PassThroughHardwareReportGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<
    PassThroughHardwareReportDtoGrid[] | undefined
  >([]);
  const { readonly, isPermesso } = useAuth();
  const getFiltersData = (state: RootState) =>
    state.passThroughHardwareReportGridReducer.filter;
  ...
  } = useFilterTableCrud<PassThroughHardwareReportQueryObjectGrid>(
    props.action.Filter,
    GetFilterColumPassThroughHardwareReport,
    props.pagination
  );
...
export default PassThroughHardwareReportGrid;
