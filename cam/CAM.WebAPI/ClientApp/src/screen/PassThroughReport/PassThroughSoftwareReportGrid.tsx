...
import { GetFilterColumPassThroughSoftwareReport } from "../../Redux/Action/Report/PassThroughSoftwareGridAction";
...
interface Props {
  ...
  data: PassThroughSoftwareReportDtoGrid[] | undefined;
  pagination: PassThroughSoftwareReportQueryObjectGrid | undefined;
  renderGrid: RenderDetail[];
}

let firstIndex, secondIndex, thirdIndex;
const PassThroughSoftwareReportGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<
    PassThroughSoftwareReportDtoGrid[] | undefined
  >([]);
  const { readonly, isPermesso } = useAuth();
  const getFiltersData = (state: RootState) =>
    state.passThroughSoftwareReportGridReducer.filter;
  ...
  } = useFilterTableCrud<PassThroughSoftwareReportQueryObjectGrid>(
    props.action.Filter,
    GetFilterColumPassThroughSoftwareReport,
    props.pagination
  );
...
export default PassThroughSoftwareReportGrid;
