...
import { GetFilterColumIdentityAsIs } from "../../Redux/Action/IdentityAsIs/IdentityAsIsGridAction";
...
interface Props {
  ...
  data: IdentityAsIsDtoGrid[] | undefined;
  pagination: IdentityAsIsQueryObjectGrid | undefined;
...
const IdentityAsIsGrid: React.FC<Props> = (props) => {
  ...
  const {
    ...
    isFiltriAttivati,
  } = useFilterTableCrud<IdentityAsIsQueryObjectGrid>(
    props.action.Filter,
    GetFilterColumIdentityAsIs,
    props.pagination
  );
        ...
        <table className="table-responsive table-thead-sticky" tabIndex={-1}>
          <thead>
            <tr className="intestazione">
              ...
              <th>
                <div className="h-100 d-flex flex-row align-items-center divFilter"></div>
              </th>
            </tr>
          </thead>
          <tbody>
...
export default React.memo(IdentityAsIsGrid);
