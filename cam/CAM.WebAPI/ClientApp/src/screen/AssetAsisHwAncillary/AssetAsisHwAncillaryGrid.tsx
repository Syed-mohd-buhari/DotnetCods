...
import {
  ...
  AssetAsisHwAncillaryDtoGrid,
} from "../../Model/Report/AssetAsisHwAncillaryExport";
import { GetFilterColumAssetAsisHwAncillary } from "../../Redux/Action/Report/AssetAsisHwAncillaryGridAction";
...
interface Props {
  ...
  data: AssetAsisHwAncillaryDtoGrid[] | undefined;
  pagination: AssetAsisHwAncillaryQueryObjectGrid | undefined;
  renderGrid: RenderDetail[];
}

let firstIndex, secondIndex, thirdIndex;
const AssetAsisHwAncillaryGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<AssetAsisHwAncillaryDtoGrid[] | undefined>(
    []
  );
  const { readonly, isPermesso } = useAuth();
  const getFiltersData = (state: RootState) =>
    state.assetAsisHwAncillaryGridReducer.filter;
  ...
  } = useFilterTableCrud<AssetAsisHwAncillaryQueryObjectGrid>(
    props.action.Filter,
    GetFilterColumAssetAsisHwAncillary,
    props.pagination
  );
...
export default AssetAsisHwAncillaryGrid;
