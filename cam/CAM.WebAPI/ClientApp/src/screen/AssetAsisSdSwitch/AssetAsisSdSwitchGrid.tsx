...
import {
  ...
  AssetAsisSdSwitchDtoGrid,
} from "../../Model/Report/AssetAsisSdSwitchExport";
import { GetFilterColumAssetAsisSdSwitch } from "../../Redux/Action/Report/AssetAsisSdSwitchGridAction";
...
interface Props {
  ...
  data: AssetAsisSdSwitchDtoGrid[] | undefined;
  pagination: AssetAsisSdSwitchQueryObjectGrid | undefined;
  renderGrid: RenderDetail[];
}

let firstIndex, secondIndex, thirdIndex;
const AssetAsisSdSwitchGrid: React.FC<Props> = (props) => {
  console.log("AssetAsisSdSwitchGrid received props:");
  console.log("- data:", props.data);
  console.log("- data length:", props.data?.length);
  console.log("- renderGrid:", props.renderGrid);
  console.log("- renderGrid length:", props.renderGrid?.length);
  console.log(
    "- visible columns:",
    props.renderGrid?.filter((x) => x.show).length
  );
  const [data, setData] = useState<AssetAsisSdSwitchDtoGrid[] | undefined>([]);
  const { readonly, isPermesso } = useAuth();
  const getFiltersData = (state: RootState) =>
    state.assetAsisSdSwitchGridReducer.filter;
  ...
  } = useFilterTableCrud<AssetAsisSdSwitchQueryObjectGrid>(
    props.action.Filter,
    GetFilterColumAssetAsisSdSwitch,
    props.pagination
  );
...
export default AssetAsisSdSwitchGrid;
