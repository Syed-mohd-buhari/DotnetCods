...
const BuiltCapacityForRegistered: React.FC<Props> = (props) => {
        ...
        <table className="w-100">
          <thead>
            <tr className="intestazione">
              <th
                className="customVolteKPIHead custom-padding"
              ...
              <th
                className="customVolteKPIHead customPadding"
                style={{ fontSize: "14px" }}
                colSpan={3}
              >
                Q4
            ...
            <tr>
              ...
              {months.map((el, idx) => (
                <th
                  key={el + idx}
                  className="customVolteKPIHead text-center px-4 ptb-15"
                  style={{ fontSize: "14px" }}
                >
                  {el}
                </th>
                ...
                {el.monthValues?.map((el, i) => (
                  <td
                    ...
                    style={{
                      ...
                      color: `${
                        el.backgroundColor === "white" ? "black" : "white"
                      } `,
                    }}
                  >
                    {el.value}
...
export default BuiltCapacityForRegistered;
