...
import { GetFilterColumTSRReport } from "../../Redux/Action/TSRReport/TemsTSRReportGridAction";
...
const TemsTSRReportGrid: React.FC<Props> = (props) => {
  ...
  const getFiltersData = (state: RootState) =>
    state.temsTsrReportGridReducer.filter;
...
export default TemsTSRReportGrid;
