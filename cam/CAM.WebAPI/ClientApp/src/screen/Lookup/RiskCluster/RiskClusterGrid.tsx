...
import { GetFilterColumProblemCategory } from "../../../Redux/Action/LookUp/ProblemCategory/ProblemCategoryGridAction";
import {
              ...
              {props.renderGrid
                ...
                .map((item, i) =>
                  SelectFilterType(
                    ...
                    undefined,
                    undefined,
                    item.propertyName.toLowerCase() === "riskClusterDescription"
                      ? "Description"
                      : item.propertyName === "riskClusterId"
                      ? "Id"
                      : undefined
                  )
                )}
            ...
            {data &&
              data?.map((item, i) => (
                <tr
                  ...
                  onDoubleClick={(e) => toggleDropdown(item.riskClusterId, e)}
                >
                  {props.renderGrid
                    .sort((a, b) => a.order - b.order)
                    .filter((x) => x.show)
                  ...
                  <td className="actions">
                    {
                      <div className="d-inline mx-2 cursor-pointer">
                        <img
                          ...
                          onClick={(e) => toggleDropdown(item.riskClusterId, e)}
                        />
                      </div>
                    }
                  </td>
...
export default RiskClusterGrid;
