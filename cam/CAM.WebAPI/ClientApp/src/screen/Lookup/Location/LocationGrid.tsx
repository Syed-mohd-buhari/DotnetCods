...
import { GetFilterColumLocation } from "../../../Redux/Action/LookUp/Location/LocationGridAction";
import {
...
interface Props {
  action: {
    ...
    Filter(obj: SetStateAction<LocationQueryObjectGrid> | undefined): any;
  };
  data: LocationDtoGrid[] | undefined;
  pagination: LocationQueryObjectGrid | undefined;

  renderGrid: RenderDetail[];
}

const LocationGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<LocationDtoGrid[] | undefined>([]);
  const getFiltersData = (state: RootState) => state.locationGridReducer.filter;
  ...
  } = useFilterTableCrud<LocationQueryObjectGrid>(
    props.action.Filter,
