                ...
                .map((item, i) =>
                  SelectFilterType(
                    ...
                    item.propertyName.toLowerCase() ===
                      ...
                      ? "Description"
                      : item.propertyName === "problemCategoryId"
                      ? "Id"
                      : undefined
                  )
                )}
            ...
            {data &&
              data?.map((item, i) => (
                <tr
                  ...
                  onDoubleClick={(e) =>
                    toggleDropdown(item.problemCategoryId, e)
                  }
                >
                  {props.renderGrid
                    .sort((a, b) => a.order - b.order)
...
export default ProblemCategoryGrid;
