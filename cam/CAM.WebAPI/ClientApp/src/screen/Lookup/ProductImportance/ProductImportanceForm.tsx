...
import { CreatProductImportance } from "../../../Redux/Action/LookUp/ProductImportance/ProductImportanceCreateAction";
import { EditProductImportance } from "../../../Redux/Action/LookUp/ProductImportance/ProductImportanceEditAction";
import { GetProductImportanceGrid } from "../../../Redux/Action/LookUp/ProductImportance/ProductImportanceGridAction";
...
const ActivityStatusForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    CreatProductImportance,
    EditProductImportance
  );

  const dtoEditResourceState = (state: RootState) =>
    state.productImportanceEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.productImportanceCreateReducer.LookUpDtoCreate;
