...
import { GetFilterColumAssetCategory } from "../../../Redux/Action/LookUp/AssetCategory/AssetCategoryGridAction";
import {
...
interface Props {
  action: {
    ...
    Filter(obj: SetStateAction<AssetCategoryQueryObjectGrid> | undefined): any;
  };
  data: AssetCategoryDtoGrid[] | undefined;
  pagination: AssetCategoryQueryObjectGrid | undefined;

  renderGrid: RenderDetail[];
}

const AssetCategoryGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<AssetCategoryDtoGrid[] | undefined>([]);
  const getFiltersData = (state: RootState) =>
    state.assetCategoryGridReducer.filter;
  ...
  } = useFilterTableCrud<AssetCategoryQueryObjectGrid>(
    props.action.Filter,
