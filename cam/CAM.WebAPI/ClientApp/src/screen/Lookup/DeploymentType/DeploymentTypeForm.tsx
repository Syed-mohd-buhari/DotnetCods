...
import { CreatDeploymentType } from "../../../Redux/Action/LookUp/DeploymentType/DeploymentTypeCreateAction";
import { EditDeploymentType } from "../../../Redux/Action/LookUp/DeploymentType/DeploymentTypeEditAction";
...
const DeploymentTypeForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.deploymentTypeEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.deploymentTypeCreateReducer.LookUpDtoCreate;
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                Location Type<span className="red">*</span>
                <input
                  type="text"
...
export default DeploymentTypeForm;
