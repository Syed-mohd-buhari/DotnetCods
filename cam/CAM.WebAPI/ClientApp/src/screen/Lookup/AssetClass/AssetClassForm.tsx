...
import {
  ...
  CreatAssetClass,
} from "../../../Redux/Action/LookUp/AssetClass/AssetClassCreateAction";
import { EditAssetClass } from "../../../Redux/Action/LookUp/AssetClass/AssetClassEditAction";

import { AssetClassDto } from "../../../Model/LookUp/AssetClass";
...
const AssetClassForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<AssetClassDto>(CreatAssetClass, EditAssetClass);

  const dtoEditResourceState = (state: RootState) =>
    state.assetClassEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.assetClassCreateReducer.LookUpDtoCreate;
  ...
  const validazioneClient = (copy: AssetClassDto) => {
