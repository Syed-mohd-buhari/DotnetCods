...
import {
  GetRelatesToResourceCreateResource,
  CreatRelatesToResource,
} from "../../../Redux/Action/LookUp/RelatesToResource/RelatesToResourceCreateAction";
import { deleteRelatesToResource } from "../../../Redux/Action/LookUp/RelatesToResource/RelatesToResourceDeleteAction";
import {
  GetRelatesToResourceEditResource,
  EditRelatesToResource,
} from "../../../Redux/Action/LookUp/RelatesToResource/RelatesToResourceEditAction";
import {
  GetRelatesToResourceGrid,
  GetFilterColumRelatesToResource,
} from "../../../Redux/Action/LookUp/RelatesToResource/RelatesToResourceGridAction";
import {
...
const RelatesToResourceForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.relatesToResourceEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.relatesToResourceCreateReducer.LookUpDtoCreate;
...
export default RelatesToResourceForm;
