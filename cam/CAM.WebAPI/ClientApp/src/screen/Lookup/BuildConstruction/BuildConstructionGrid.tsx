...
import { GetFilterColumBuildConstruction } from "../../../Redux/Action/LookUp/BuildConstruction/BuildConstructionGridAction";
import {
...
const BuildConstructionGrid: React.FC<Props> = (props) => {
  ...
  const {
    ...
    props.action.Filter,
    GetFilterColumBuildConstruction,
    props.pagination
  );
...
export default BuildConstructionGrid;
