...
import { GetFilterColumDeliveryStatus } from "../../../Redux/Action/LookUp/DeliveryStatus/DeliveryStatusGridAction";
import {
...
const DeliveryStatusGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<
    TipologicaGridDtoCombinationRule[] | undefined
  >([]);
  const getFiltersData = (state: RootState) =>
    state.deliveryStatusGridReducer.filter;
...
export default DeliveryStatusGrid;
