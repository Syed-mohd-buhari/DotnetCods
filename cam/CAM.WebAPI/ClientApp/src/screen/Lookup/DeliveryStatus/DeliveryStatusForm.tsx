...
import { CreatDeliveryStatus } from "../../../Redux/Action/LookUp/DeliveryStatus/DeliveryStatusCreateAction";
import { EditDeliveryStatus } from "../../../Redux/Action/LookUp/DeliveryStatus/DeliveryStatusEditAction";
...
const DeliveryStatusForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.deliveryStatusEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.deliveryStatusCreateReducer.LookUpDtoCreate;
