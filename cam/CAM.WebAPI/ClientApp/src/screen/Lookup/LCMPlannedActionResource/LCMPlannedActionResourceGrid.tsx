...
import { GetFilterColumLCMPlannedActionResource } from "../../../Redux/Action/LookUp/LCMPlannedActionResource/LCMPlannedActionResourceGridAction";
import {
...
const LCMPlannedActionResourceGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<TipologicaGridDto[] | undefined>([]);
  const getFiltersData = (state: RootState) =>
    state.lCMPlannedActionResourceGridReducer.filter;
  ...
  const {
    ...
    props.action.Filter,
    GetFilterColumLCMPlannedActionResource,
    props.pagination
  );
...
export default LCMPlannedActionResourceGrid;
