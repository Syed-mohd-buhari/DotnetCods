...
import {
  ...
  CreatActivityStatus,
} from "../../../Redux/Action/LookUp/ActivityStatus/ActivityStatusCreateAction";
import { deleteActivityStatus } from "../../../Redux/Action/LookUp/ActivityStatus/ActivityStatusDeleteAction";
import {
  GetActivityStatusEditResource,
  EditActivityStatus,
} from "../../../Redux/Action/LookUp/ActivityStatus/ActivityStatusEditAction";
import {
...
const ActivityStatusForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.activityStatusEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.activityStatusCreateReducer.LookUpDtoCreate;
