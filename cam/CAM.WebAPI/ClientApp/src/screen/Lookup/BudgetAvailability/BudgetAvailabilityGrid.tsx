...
import { GetFilterColumBudgetAvailability } from "../../../Redux/Action/LookUp/BudgetAvailability/BudgetAvailabilityGridAction";
import {
...
const BudgetAvailabilityGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<
    TipologicaGridDtoCombinationRule[] | undefined
  >([]);
  const getFiltersData = (state: RootState) =>
    state.budgetAvailabilityGridReducer.filter;
  ...
  const {
    ...
    props.action.Filter,
    GetFilterColumBudgetAvailability,
    props.pagination
  );
  ...
  return (
    <div className="listaApparatiContainer mt-3 row mx-0 col-12 p-0 d-flex justify-content-center">
      <div className="col-12 col-12 py-3">
...
export default BudgetAvailabilityGrid;
