...
import { CreatResponsibilityPhase } from "../../../Redux/Action/LookUp/ResponsibilityPhase/ResponsibilityPhaseCreateAction";
import { EditResponsibilityPhase } from "../../../Redux/Action/LookUp/ResponsibilityPhase/ResponsibilityPhaseEditAction";
...
const ResponsibilityPhaseForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    CreatResponsibilityPhase,
    EditResponsibilityPhase
  );

  const dtoEditResourceState = (state: RootState) =>
    state.responsibilityPhaseEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.responsibilityPhaseCreateReducer.LookUpDtoCreate;
...
export default ResponsibilityPhaseForm;
