...
import { CreatEquipmentStatus } from "../../../Redux/Action/LookUp/EquipmentStatus/EquipmentStatusCreateAction";
import { EditEquipmentStatus } from "../../../Redux/Action/LookUp/EquipmentStatus/EquipmentStatusEditAction";
...
const EquipmentStatusForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    CreatEquipmentStatus,
    EditEquipmentStatus
  );

  const dtoEditResourceState = (state: RootState) =>
    state.equipmentStatusEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.equipmentStatusCreateReducer.LookUpDtoCreate;
