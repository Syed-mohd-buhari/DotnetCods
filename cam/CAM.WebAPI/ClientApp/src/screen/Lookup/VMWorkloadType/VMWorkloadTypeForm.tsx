...
import {
  ...
  CreatVMWorkloadType,
} from "../../../Redux/Action/LookUp/VMWorkloadType/VMWorkloadTypeCreateAction";
import { deleteLocation } from "../../../Redux/Action/LookUp/Location/LocationDeleteAction";
import {
  GetVMWorkloadTypeEditResource,
  EditVMWorkloadType,
} from "../../../Redux/Action/LookUp/VMWorkloadType/VMWorkloadTypeEditAction";
import {
  GetVMWorkloadTypeGrid,
  GetFilterColumVMWorkloadType,
...
import { VMWorkloadTypeDto } from "../../../Model/LookUp/VMWorkloadType";
...
const VMWorkloadTypeForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<VMWorkloadTypeDto>(
    CreatVMWorkloadType,
    EditVMWorkloadType
  );

  const dtoEditResourceState = (state: RootState) =>
    state.vMWorkloadTypeEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.vMWorkloadTypeCreateReducer.LookUpDtoCreate;
  ...
  const validazioneClient = (copy: VMWorkloadTypeDto) => {
  ...
  const onChangeDefault = (checked: boolean) => {
    const copy = { ...formData } as VMWorkloadTypeDto;
  ...
  const OnChangeMultiSelect = (property: string, e: any) => {
    ...
    let copy = { ...formData } as VMWorkloadTypeDto;
...
export default VMWorkloadTypeForm;
