...
import { GetFilterColumSharedLookUp } from "../../../Redux/Action/LookUp/SharedLookUp/SharedLookUpGridAction";
...
interface Props {
  action: {
    onDelete(id: number | undefined, apiType?: string): any;
                  ...
                  <td className="actions">
                    <Dropdown className="d-inline mx-2">
                      ...
                      <Dropdown.Menu>
                        ...
                        <Dropdown.Item
                          onClick={() =>
                            props.action.onDelete(item.id, props.apiType)
                          }
                        >
                          Delete
                        </Dropdown.Item>
...
export default SharedLookUpGrid;
