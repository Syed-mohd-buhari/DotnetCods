...
import {
  ...
  CreatNetworkConstruct,
} from "../../../Redux/Action/LookUp/NetworkConstruct/NetworkConstructCreateAction";
import { deleteNetworkConstruct } from "../../../Redux/Action/LookUp/NetworkConstruct/NetworkConstructDeleteAction";
import {
  GetNetworkConstructEditResource,
  EditNetworkConstruct,
} from "../../../Redux/Action/LookUp/NetworkConstruct/NetworkConstructEditAction";
import {
  GetNetworkConstructGrid,
  GetFilterColumNetworkConstruct,
...
const NetworkConstructForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.networkConstructEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.networkConstructCreateReducer.LookUpDtoCreate;
...
export default NetworkConstructForm;
