...
import {
  ...
  CreatEndOfSupportContract,
} from "../../../Redux/Action/LookUp/EndOfSupportContract/EndOfSupportContractCreateAction";
import { deleteEndOfSupportContract } from "../../../Redux/Action/LookUp/EndOfSupportContract/EndOfSupportContractDeleteAction";
import {
  GetEndOfSupportContractEditResource,
  EditEndOfSupportContract,
} from "../../../Redux/Action/LookUp/EndOfSupportContract/EndOfSupportContractEditAction";
import {
  GetEndOfSupportContractGrid,
  GetFilterColumEndOfSupportContract,
...
const EndOfSupportContractForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.endOfSupportContractEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.endOfSupportContractCreateReducer.LookUpDtoCreate;
...
export default EndOfSupportContractForm;
