...
import { GetFilterColumEndOfSupportContract } from "../../../Redux/Action/LookUp/EndOfSupportContract/EndOfSupportContractGridAction";
import {
...
const EndOfSupportContractGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<TipologicaGridDto[] | undefined>([]);
  const getFiltersData = (state: RootState) =>
    state.endOfSupportContractGridReducer.filter;
...
export default EndOfSupportContractGrid;
