...
import { CreatPlanningActivityStatus } from "../../../Redux/Action/LookUp/PlanningActivityStatus/PlanningActivityStatusCreateAction";
import { EditPlanningActivityStatus } from "../../../Redux/Action/LookUp/PlanningActivityStatus/PlanningActivityStatusEditAction";

import { TipologicaGridDtoProjectStatusCombinationRule } from "../../../Model/LookUp/LookUpGenericModel";
...
const PlanningActivityStatusForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    onChange,
    setChanged,
  } = useFormTableCrud<TipologicaGridDtoProjectStatusCombinationRule>(
    CreatPlanningActivityStatus,
    EditPlanningActivityStatus
  );

  const dtoEditResourceState = (state: RootState) =>
    state.planningActivityStatusEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.planningActivityStatusCreateReducer.LookUpDtoCreate;
  ...
  const validazioneClient = (
    copy: TipologicaGridDtoProjectStatusCombinationRule
  ) => {
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                Planning Activity Status<span className="red">*</span>
                <input
                  type="text"
...
export default PlanningActivityStatusForm;
