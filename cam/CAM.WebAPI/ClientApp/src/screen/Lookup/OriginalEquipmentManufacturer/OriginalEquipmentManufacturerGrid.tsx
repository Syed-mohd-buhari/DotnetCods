...
import { GetFilterColumOriginalEquipmentManufacturer } from "../../../Redux/Action/LookUp/OriginalEquipmentManufacturer/OriginalEquipmentManufacturerGridAction";
import {
...
const OriginalEquipmentManufacturerGrid: React.FC<Props> = (props) => {
  ...
  const {
    ...
    props.action.Filter,
    GetFilterColumOriginalEquipmentManufacturer,
    props.pagination
  );
...
export default OriginalEquipmentManufacturerGrid;
