...
import { CreatSecurityTireZone } from "../../../Redux/Action/LookUp/SecurityTireZone/SecurityTireZoneCreateAction";
import { EditSecurityTireZone } from "../../../Redux/Action/LookUp/SecurityTireZone/SecurityTireZoneEditAction";
...
const SecurityTireZoneForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    CreatSecurityTireZone,
    EditSecurityTireZone
  );

  const dtoEditResourceState = (state: RootState) =>
    state.securityTireZoneEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.securityTireZoneCreateReducer.LookUpDtoCreate;
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold mb-0 w-100">
                Security Tier Zone<span className="red">*</span>
                <input
                  type="text"
...
export default SecurityTireZoneForm;
