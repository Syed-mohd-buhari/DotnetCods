...
import { GetFilterColumSecurityTireZone } from "../../../Redux/Action/LookUp/SecurityTireZone/SecurityTireZoneGridAction";
import {
...
const SecurityTireZoneGrid: React.FC<Props> = (props) => {
  ...
  const {
    ...
    props.action.Filter,
    GetFilterColumSecurityTireZone,
    props.pagination
  );
...
export default SecurityTireZoneGrid;
