...
import { CreatBusinessContinuityMethod } from "../../../Redux/Action/LookUp/BusinessContinuityMethod/BusinessContinuityMethodCreateAction";
import { EditBusinessContinuityMethod } from "../../../Redux/Action/LookUp/BusinessContinuityMethod/BusinessContinuityMethodEditAction";
...
const BusinessContinuityMethodForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    CreatBusinessContinuityMethod,
    EditBusinessContinuityMethod
  );

  const dtoEditResourceState = (state: RootState) =>
    state.businessContinuityMethodEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.businessContinuityMethodCreateReducer.LookUpDtoCreate;
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                Sub - Domain Responsible<span className="red fz-20">*</span>
                <input
                  type="text"
...
export default BusinessContinuityMethodForm;
