...
import { GetFilterColumPlatform } from "../../../Redux/Action/LookUp/Platform/PlatformGridAction";
import {
...
const PlatformGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<TipologicaGridDto[] | undefined>([]);
  const getFiltersData = (state: RootState) => state.platformGridReducer.filter;
