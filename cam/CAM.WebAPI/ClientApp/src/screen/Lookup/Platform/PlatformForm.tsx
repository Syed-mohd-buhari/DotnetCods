...
import { CreatPlatform } from "../../../Redux/Action/LookUp/Platform/PlatformCreateAction";
import { EditPlatform } from "../../../Redux/Action/LookUp/Platform/PlatformEditAction";
...
const PlatformForm: React.FC<Props> = (props) => {
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<TipologicaGridDto>(CreatPlatform, EditPlatform);

  const dtoEditResourceState = (state: RootState) =>
    state.platformEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.platformCreateReducer.LookUpDtoCreate;
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                Platform<span className="red fz-20">*</span>
                <input
                  type="text"
