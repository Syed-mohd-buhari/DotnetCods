...
import { GetFilterColumMainOrganisation } from "../../../Redux/Action/LookUp/MainOrganisation/MainOrganisationGridAction";
import {
...
const MainOrganisationGrid: React.FC<Props> = (props) => {
  ...
  const {
    ...
    props.action.Filter,
    GetFilterColumMainOrganisation,
    props.pagination
  );
                ...
                .map((item, i) =>
                  SelectFilterType(
                    ...
                    item.propertyName.toLowerCase() ===
                      ...
                      ? "Description"
                      : item.propertyName === "mainOrganisationId"
                      ? "Id"
                      : undefined
                  )
                )}
                    ...
                    <Dropdown className="d-inline mx-2">
                      ...
                      <Dropdown.Menu>
                        <>
                          <Dropdown.Item
                            onClick={() =>
                              props.action.Edit(item.mainOrganisationId)
                            }
                          >
                            Edit
                          </Dropdown.Item>
                          <Dropdown.Item
                            onClick={() =>
                              props.action.Delete(item.mainOrganisationId)
                            }
                          >
                            Delete
                          </Dropdown.Item>
...
export default MainOrganisationGrid;
