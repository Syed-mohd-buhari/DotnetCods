...
import { CreatPlanningRisk } from "../../../Redux/Action/LookUp/PlanningRisk/PlanningRiskCreateAction";
import { EditPlanningRisk } from "../../../Redux/Action/LookUp/PlanningRisk/PlanningRiskEditAction";
...
const PlanningRiskForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<TipologicaGridDto>(CreatPlanningRisk, EditPlanningRisk);

  const dtoEditResourceState = (state: RootState) =>
    state.planningRiskEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.planningRiskCreateReducer.LookUpDtoCreate;
...
export default PlanningRiskForm;
