...
import {
  ...
  CreatSupportedResource,
} from "../../../Redux/Action/LookUp/SupportedResource/SupportedResourceCreateAction";
import { EditSupportedResource } from "../../../Redux/Action/LookUp/SupportedResource/SupportedResourceEditAction";
import {
  TipologicaGridDto,
...
const SupportedResourceForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    CreatSupportedResource,
    EditSupportedResource
  );

  const dtoEditResourceState = (state: RootState) =>
    state.supportedResourceEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.supportedResourceCreateReducer.LookUpDtoCreate;
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                Supported Resource<span className="red">*</span>
                <input
                  type="text"
