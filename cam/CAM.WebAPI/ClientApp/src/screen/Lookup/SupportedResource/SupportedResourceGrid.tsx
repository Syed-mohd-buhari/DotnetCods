...
import { GetFilterColumSupportedResource } from "../../../Redux/Action/LookUp/SupportedResource/SupportedResourceGridAction";
import {
...
const SupportedResourceGrid: React.FC<Props> = (props) => {
  ...
  const {
    ...
    props.action.Filter,
    GetFilterColumSupportedResource,
    props.pagination
  );
...
export default SupportedResourceGrid;
