...
import { GetFilterColumSupportedService } from "../../../Redux/Action/LookUp/SupportedService/SupportedServiceGridAction";
import {
...
interface Props {
  action: {
    ...
    Filter(
      obj: SetStateAction<SupportedServiceQueryObjectGrid> | undefined
    ): any;
  };
  data: SupportedServiceDtoGrid[] | undefined;
  pagination: SupportedServiceQueryObjectGrid | undefined;

  renderGrid: RenderDetail[];
}

const SupportedServiceGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<SupportedServiceDtoGrid[] | undefined>([]);
  const getFiltersData = (state: RootState) =>
    state.supportedServiceGridReducer.filter;
  ...
  } = useFilterTableCrud<SupportedServiceQueryObjectGrid>(
    props.action.Filter,
    GetFilterColumSupportedService,
    props.pagination
  );
                  ...
                  <td className="actions">
                    <Dropdown className="d-inline mx-2">
                      ...
                      <Dropdown.Menu>
                        <Dropdown.Item
                          disabled={
                            item?.description === "Supported All Services"
                          }
...
export default SupportedServiceGrid;
