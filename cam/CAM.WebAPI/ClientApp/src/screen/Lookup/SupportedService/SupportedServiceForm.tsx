...
import { CreatSupportedService } from "../../../Redux/Action/LookUp/SupportedService/SupportedServiceCreateAction";
import { EditSupportedService } from "../../../Redux/Action/LookUp/SupportedService/SupportedServiceEditAction";

import { SupportedServiceDto } from "../../../Model/LookUp/SupportedService";
...
const SupportedServiceForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<SupportedServiceDto>(
    CreatSupportedService,
    EditSupportedService
  );

  const dtoEditResourceState = (state: RootState) =>
    state.supportedServiceEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.supportedServiceCreateReducer.LookUpDtoCreate;
  ...
  const validazioneClient = (copy: SupportedServiceDto) => {
...
export default SupportedServiceForm;
