...
import { GetFilterColumDriver } from "../../../Redux/Action/LookUp/Driver/DriverGridAction";
import {
...
const DriverGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<TipologicaGridDto[] | undefined>([]);
  const getFiltersData = (state: RootState) => state.driverGridReducer.filter;
