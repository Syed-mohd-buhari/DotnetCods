...
import { CreatBenefits } from "../../../Redux/Action/LookUp/Benefits/BenefitsCreateAction";
import { EditBenefits } from "../../../Redux/Action/LookUp/Benefits/BenefitsEditAction";
...
const BenefitsForm: React.FC<Props> = (props) => {
  const {
    formData,
    setFormData,
    Save,
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<TipologicaGridDto>(CreatBenefits, EditBenefits);

  const dtoEditResourceState = (state: RootState) =>
    state.benefitsEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.benefitsCreateReducer.LookUpDtoCreate;
