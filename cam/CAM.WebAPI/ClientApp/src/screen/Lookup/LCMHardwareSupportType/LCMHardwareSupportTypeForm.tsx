...
import {
  ...
  CreatLCMHardwareSupportType,
} from "../../../Redux/Action/LookUp/LCMHardwareSupportType/LCMHardwareSupportTypeCreateAction";
...
import {
  ...
  EditLCMHardwareSupportType,
} from "../../../Redux/Action/LookUp/LCMHardwareSupportType/LCMHardwareSupportTypeEditAction";
import {
  GetLCMHardwareSupportTypeGrid,
  GetFilterColumLCMHardwareSupportType,
...
const LCMHardwareSupportTypeForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.lCMHardwareSupportTypeEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.lCMHardwareSupportTypeCreateReducer.LookUpDtoCreate;
...
export default LCMHardwareSupportTypeForm;
