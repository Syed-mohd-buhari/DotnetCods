...
import { GetFilterColumLCMHardwareSupportType } from "../../../Redux/Action/LookUp/LCMHardwareSupportType/LCMHardwareSupportTypeGridAction";
import {
...
const LCMHardwareSupportTypeGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<TipologicaGridDto[] | undefined>([]);
  const getFiltersData = (state: RootState) =>
    state.lCMHardwareSupportTypeGridReducer.filter;
...
export default LCMHardwareSupportTypeGrid;
