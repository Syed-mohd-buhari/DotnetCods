...
import {
  GetCustomerWheelCreateResource,
  CreatCustomerWheel,
} from "../../../Redux/Action/LookUp/CustomerWheel/CustomerWheelCreateAction";
import { deleteCustomerWheel } from "../../../Redux/Action/LookUp/CustomerWheel/CustomerWheelDeleteAction";
import {
  GetCustomerWheelEditResource,
  EditCustomerWheel,
} from "../../../Redux/Action/LookUp/CustomerWheel/CustomerWheelEditAction";
import {
  GetCustomerWheelGrid,
  GetFilterColumCustomerWheel,
} from "../../../Redux/Action/LookUp/CustomerWheel/CustomerWheelGridAction";
import {
...
const CustomerWheelForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.customerWheelEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.customerWheelCreateReducer.LookUpDtoCreate;
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                Customer Wheel<span className="red fz-20">*</span>
                <input
                  type="text"
...
export default CustomerWheelForm;
