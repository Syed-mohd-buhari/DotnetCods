...
import {
  ...
  CreatSystemFunction,
} from "../../../Redux/Action/LookUp/SystemFunction/SystemFunctionCreateAction";
import { deleteSystemFunction } from "../../../Redux/Action/LookUp/SystemFunction/SystemFunctionDeleteAction";
import {
  GetSystemFunctionEditResource,
  EditSystemFunction,
} from "../../../Redux/Action/LookUp/SystemFunction/SystemFunctionEditAction";
import {
  GetSystemFunctionGrid,
  GetFilterColumSystemFunction,
...
const SystemFunctionForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.systemFunctionEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.systemFunctionCreateReducer.LookUpDtoCreate;
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                System Function<span className="red">*</span>
                <input
                  type="text"
...
export default SystemFunctionForm;
