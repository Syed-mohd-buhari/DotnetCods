...
import {
  ...
  CreatSupportProvider,
} from "../../../Redux/Action/LookUp/SupportProvider/SupportProviderCreateAction";
...
import {
  ...
  EditSupportProvider,
} from "../../../Redux/Action/LookUp/SupportProvider/SupportProviderEditAction";
import {
  GetSupportProviderGrid,
  GetFilterColumSupportProvider,
...
const SupportProviderForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.supportProviderEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.supportProviderCreateReducer.LookUpDtoCreate;
...
export default SupportProviderForm;
