...
import { CreatEnvironment } from "../../../Redux/Action/LookUp/Environment/EnvironmentCreateAction";
import { EditEnvironment } from "../../../Redux/Action/LookUp/Environment/EnvironmentEditAction";
...
const EnvironmentForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setChanged,
    inputValue,
  } = useFormTableCrud<TipologicaGridDto>(CreatEnvironment, EditEnvironment);

  const dtoEditResourceState = (state: RootState) =>
    state.environmentEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.environmentCreateReducer.LookUpDtoCreate;
