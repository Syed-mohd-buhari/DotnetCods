...
import { CreatProgram } from "../../../Redux/Action/LookUp/Program/ProgramCreateAction";
import { EditProgram } from "../../../Redux/Action/LookUp/Program/ProgramEditAction";
...
const ProgramForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<TipologicaGridDto>(CreatProgram, EditProgram);

  const dtoEditResourceState = (state: RootState) =>
    state.programEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.programCreateReducer.LookUpDtoCreate;
    ...
    <div className="col-12">
      ...
      <div className="col-12 justify-content-end d-flex ">
        ...
        <button
          ...
          type="button"
        >
          {props.edit ? "Save Changes" : "Create Program"}
        </button>
      </div>
    </div>
  );
