...
import { GetFilterColumProgram } from "../../../Redux/Action/LookUp/Program/ProgramGridAction";
import {
...
const ProgramGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<TipologicaGridDto[] | undefined>([]);
  const getFiltersData = (state: RootState) => state.programGridReducer.filter;
