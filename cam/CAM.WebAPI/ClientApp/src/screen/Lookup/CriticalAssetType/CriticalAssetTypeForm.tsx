...
import { CreatCriticalAssetType } from "../../../Redux/Action/LookUp/CriticalAssetType/CriticalAssetTypeCreateAction";
import { EditCriticalAssetType } from "../../../Redux/Action/LookUp/CriticalAssetType/CriticalAssetTypeEditAction";
import {
...
const CriticalAssetTypeForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<CriticalAssetTypeDto>(
    CreatCriticalAssetType,
    EditCriticalAssetType
  );

  const dtoEditResourceState = (state: RootState) =>
    state.criticalAssetTypeEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.criticalAssetTypeCreateReducer.LookUpDtoCreate;
  ...
  const validazioneClient = (copy: CriticalAssetTypeDto) => {
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                Software Family<span className="red">*</span>
                <input
                  type="text"
...
export default CriticalAssetTypeForm;
