...
} from "../../../Redux/Action/LookUp/Class/ClassCreateAction";
import { EditClass } from "../../../Redux/Action/LookUp/Class/ClassEditAction";
import { ClassDto, ClassDtoGrid } from "../../../Model/LookUp/Class";
...
const ClassForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<ClassDto>(CreatClass, EditClass);

  const dtoEditResourceState = (state: RootState) =>
    state.ClassEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.ClassCreateReducer.LookUpDtoCreate;
  ...
  const validazioneClient = (copy: ClassDto) => {
    ...
    console.log(copy?.categoryId, "categoryid");
                ...
                <div className="d-flex">
                  <div className="w-100">
                    ...
                    menuPosition={"fixed"}
                      ...
                      value={
                        formData?.categoryResource &&
                        dictionaryToArray(formData?.categoryResource).filter(
