...
import { GetFilterColumReasonCheckbox } from "../../../Redux/Action/LookUp/ReasonCheckbox/ReasonCheckboxGridAction";
import {
...
interface Props {
  action: {
    ...
    Filter(obj: SetStateAction<ReasonCheckboxQueryObjectGrid> | undefined): any;
  };
  data: ReasonCheckboxDto[] | undefined;
  pagination: ReasonCheckboxQueryObjectGrid | undefined;

  renderGrid: RenderDetail[];
}

const ReasonCheckboxGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<ReasonCheckboxDto[] | undefined>([]);
  const getFiltersData = (state: RootState) =>
    state.reasonCheckboxGridReducer.filter;
  ...
  } = useFilterTableCrud<ReasonCheckboxQueryObjectGrid>(
    props.action.Filter,
    GetFilterColumReasonCheckbox,
    props.pagination
  );
...
export default ReasonCheckboxGrid;
