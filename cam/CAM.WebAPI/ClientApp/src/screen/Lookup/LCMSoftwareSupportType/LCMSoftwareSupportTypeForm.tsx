...
import {
  ...
  CreatLCMSoftwareSupportType,
} from "../../../Redux/Action/LookUp/LCMSoftwareSupportType/LCMSoftwareSupportTypeCreateAction";
...
import {
  ...
  EditLCMSoftwareSupportType,
} from "../../../Redux/Action/LookUp/LCMSoftwareSupportType/LCMSoftwareSupportTypeEditAction";
import {
  GetLCMSoftwareSupportTypeGrid,
  GetFilterColumLCMSoftwareSupportType,
} from "../../../Redux/Action/LookUp/LCMSoftwareSupportType/LCMSoftwareSupportTypeGridAction";
import {
  TipologicheQueryObjectGrid,
  TipologicaGridDto,
} from "../../../Model/LookUp/LookUpGenericModel";
import { LCMSoftwareSupportTypeDto } from "../../../Model/LookUp/LCMSoftwareSupportType";
...
const LCMSoftwareSupportTypeForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<LCMSoftwareSupportTypeDto>(
    CreatLCMSoftwareSupportType,
    EditLCMSoftwareSupportType
  );

  const dtoEditResourceState = (state: RootState) =>
    state.lCMSoftwareSupportTypeEditReducer.Create;
  const dtoNewResourceState = (state: RootState) =>
    state.lCMSoftwareSupportTypeCreateReducer.Create;
  ...
  const validazioneClient = (copy: LCMSoftwareSupportTypeDto) => {
        ...
        <div className="row col-12 px-0">
          ...
          <div className="col-3 pt-3">
            <div className="d-flex align-items-center">
              <label className="labelForm voda-bold   w-100 d-flex align-items-center mb-0">
                <input
                  type="checkbox"
                  onChange={(e) => onChange("oemSupport", e)}
                  className="inputForm mb-1 mr-1"
                  checked={formData?.oemSupport}
                />
                OEM Support
              </label>
            </div>
          ...
          <div className="col-3 pt-3">
            <div className="d-flex align-items-center">
              <label className="labelForm voda-bold   w-100 d-flex align-items-center mb-0">
                <input
                  type="checkbox"
                  onChange={(e) => onChange("warranty", e)}
                  className="inputForm mb-1 mr-1"
...
export default LCMSoftwareSupportTypeForm;
