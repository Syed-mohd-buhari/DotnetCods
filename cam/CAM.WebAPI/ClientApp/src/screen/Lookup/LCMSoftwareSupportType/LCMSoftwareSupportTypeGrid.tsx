...
import { GetFilterColumLCMSoftwareSupportType } from "../../../Redux/Action/LookUp/LCMSoftwareSupportType/LCMSoftwareSupportTypeGridAction";
import {
...
interface Props {
  action: {
    ...
    Filter(
      obj: SetStateAction<LCMSoftwareSupportTypeQueryObjectGrid> | undefined
    ): any;
  };
  data: LCMSoftwareSupportTypeDtoGrid[] | undefined;
  pagination: LCMSoftwareSupportTypeQueryObjectGrid | undefined;

  renderGrid: RenderDetail[];
}

const LCMSoftwareSupportTypeGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<LCMSoftwareSupportTypeDtoGrid[] | undefined>(
    []
  );
  const getFiltersData = (state: RootState) =>
    state.lCMSoftwareSupportTypeGridReducer.filter;
  ...
  } = useFilterTableCrud<LCMSoftwareSupportTypeQueryObjectGrid>(
    props.action.Filter,
...
export default LCMSoftwareSupportTypeGrid;
