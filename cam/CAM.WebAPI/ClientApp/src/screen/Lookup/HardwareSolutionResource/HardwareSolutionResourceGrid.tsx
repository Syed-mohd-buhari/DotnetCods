...
import { GetFilterColumHardwareSolutionResource } from "../../../Redux/Action/LookUp/HardwareSolutionResource/HardwareSolutionResourceGridAction";
import {
...
const HardwareSolutionResourceGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<TipologicaGridDto[] | undefined>([]);
  const getFiltersData = (state: RootState) =>
    state.hardwareSolutionResourceGridReducer.filter;
...
export default HardwareSolutionResourceGrid;
