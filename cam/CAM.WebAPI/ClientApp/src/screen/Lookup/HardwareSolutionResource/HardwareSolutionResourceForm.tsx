...
import {
  ...
  CreatHardwareSolutionResource,
} from "../../../Redux/Action/LookUp/HardwareSolutionResource/HardwareSolutionResourceCreateAction";
import { deleteHardwareSolutionResource } from "../../../Redux/Action/LookUp/HardwareSolutionResource/HardwareSolutionResourceDeleteAction";
import {
  GetHardwareSolutionResourceEditResource,
  EditHardwareSolutionResource,
} from "../../../Redux/Action/LookUp/HardwareSolutionResource/HardwareSolutionResourceEditAction";
import {
  GetHardwareSolutionResourceGrid,
  GetFilterColumHardwareSolutionResource,
...
const HardwareSolutionResourceForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.hardwareSolutionResourceEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.hardwareSolutionResourceCreateReducer.LookUpDtoCreate;
...
export default HardwareSolutionResourceForm;
