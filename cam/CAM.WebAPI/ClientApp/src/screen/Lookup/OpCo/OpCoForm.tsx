...
import { CreatOpCo } from "../../../Redux/Action/LookUp/OpCo/OpCoCreateAction";
import { EditOpCo } from "../../../Redux/Action/LookUp/OpCo/OpCoEditAction";
...
const OpCoForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<TipologicaGridDto>(CreatOpCo, EditOpCo);

  const dtoEditResourceState = (state: RootState) =>
    state.opCoEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.opCoCreateReducer.LookUpDtoCreate;
