...
import {
  ...
  CreatServiceMaster,
} from "../../../Redux/Action/LookUp/ServiceMaster/ServiceMasterCreateAction";
import { deleteLocation } from "../../../Redux/Action/LookUp/Location/LocationDeleteAction";
import { EditServiceMaster } from "../../../Redux/Action/LookUp/ServiceMaster/ServiceMasterEditAction";
...
import { ServiceMasterDto } from "../../../Model/LookUp/ServiceMaster";
...
const ServiceMasterForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<ServiceMasterDto>(CreatServiceMaster, EditServiceMaster);

  const dtoEditResourceState = (state: RootState) =>
    state.serviceMasterEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.serviceMasterCreateReducer.LookUpDtoCreate;
  ...
  const validazioneClient = (copy: ServiceMasterDto) => {
  ...
  const onChangeDefault = (checked: boolean) => {
    const copy = { ...formData } as ServiceMasterDto;
  ...
  const OnChangeMultiSelect = (property: string, e: any) => {
    ...
    let copy = { ...formData } as ServiceMasterDto;
