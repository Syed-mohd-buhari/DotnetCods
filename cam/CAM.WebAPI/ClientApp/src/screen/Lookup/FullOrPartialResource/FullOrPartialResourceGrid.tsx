...
import { GetFilterColumFullOrPartialResource } from "../../../Redux/Action/LookUp/FullOrPartialResource/FullOrPartialResourceGridAction";
import {
...
const FullOrPartialResourceGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<TipologicaGridDto[] | undefined>([]);
  const getFiltersData = (state: RootState) =>
    state.fullOrPartialResourceGridReducer.filter;
...
export default FullOrPartialResourceGrid;
