...
import {
  GetFullOrPartialResourceCreateResource,
  CreatFullOrPartialResource,
} from "../../../Redux/Action/LookUp/FullOrPartialResource/FullOrPartialResourceCreateAction";
import { deleteFullOrPartialResource } from "../../../Redux/Action/LookUp/FullOrPartialResource/FullOrPartialResourceDeleteAction";
import {
  GetFullOrPartialResourceEditResource,
  EditFullOrPartialResource,
} from "../../../Redux/Action/LookUp/FullOrPartialResource/FullOrPartialResourceEditAction";
import {
  GetFullOrPartialResourceGrid,
  GetFilterColumFullOrPartialResource,
} from "../../../Redux/Action/LookUp/FullOrPartialResource/FullOrPartialResourceGridAction";
import {
...
const FullOrPartialResourceForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.fullOrPartialResourceEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.fullOrPartialResourceCreateReducer.LookUpDtoCreate;
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                Full Or Partial Resource<span className="red">*</span>
                <input
                  type="text"
...
export default FullOrPartialResourceForm;
