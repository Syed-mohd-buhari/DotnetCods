...
import { CreatVerticalResponsible } from "../../../Redux/Action/LookUp/VerticalResponsible/VerticalResponsibleCreateAction";
import { EditVerticalResponsible } from "../../../Redux/Action/LookUp/VerticalResponsible/VerticalResponsibleEditAction";
...
const VerticalResponsibleForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    CreatVerticalResponsible,
    EditVerticalResponsible
  );

  const dtoEditResourceState = (state: RootState) =>
    state.verticalResponsibleEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.verticalResponsibleCreateReducer.LookUpDtoCreate;
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                Vertical Responsible<span className="red fz-20">*</span>
                <input
                  type="text"
...
export default VerticalResponsibleForm;
