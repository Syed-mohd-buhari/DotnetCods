...
import {
  ...
  CreatNetworkFunction,
} from "../../../Redux/Action/LookUp/NetworkFunction/NetworkFunctionCreateAction";
import { EditNetworkFunction } from "../../../Redux/Action/LookUp/NetworkFunction/NetworkFunctionEditAction";

import { NetworkFunctionDto } from "../../../Model/LookUp/NetworkFunction";
...
const NetworkFunctionForm: React.FC<Props> = (props) => {
  ...
  const {
    ...
    setInputValue,
    promiseSelect,
  } = useFormTableCrud<NetworkFunctionDto>(
    CreatNetworkFunction,
    EditNetworkFunction
  );

  const dtoEditResourceState = (state: RootState) =>
    state.networkFunctionEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.networkFunctionCreateReducer.LookUpDtoCreate;
  ...
  const validazioneClient = (copy: NetworkFunctionDto) => {
    ...
    // console.log("descrrrrr ", copy?.description);
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                Functional Entity <span className="red">*</span>
                <input
                  type="text"
...
export default NetworkFunctionForm;
