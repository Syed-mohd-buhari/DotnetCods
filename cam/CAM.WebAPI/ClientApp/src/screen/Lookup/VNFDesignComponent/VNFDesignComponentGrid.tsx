...
import { GetFilterColumVNFDesignComponent } from "../../../Redux/Action/LookUp/VNFDesignComponent/VNFDesignComponentGridAction";
import {
...
const VNFDesignComponentGrid: React.FC<Props> = (props) => {
  const [data, setData] = useState<TipologicaGridDto[] | undefined>([]);
  const getFiltersData = (state: RootState) =>
    state.vNFDesignComponentGridReducer.filter;
...
export default VNFDesignComponentGrid;
