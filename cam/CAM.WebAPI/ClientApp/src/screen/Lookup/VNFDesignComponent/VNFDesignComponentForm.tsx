...
import {
  ...
  CreatVNFDesignComponent,
} from "../../../Redux/Action/LookUp/VNFDesignComponent/VNFDesignComponentCreateAction";
import { deleteVNFDesignComponent } from "../../../Redux/Action/LookUp/VNFDesignComponent/VNFDesignComponentDeleteAction";
import {
  GetVNFDesignComponentEditResource,
  EditVNFDesignComponent,
} from "../../../Redux/Action/LookUp/VNFDesignComponent/VNFDesignComponentEditAction";
import {
  GetVNFDesignComponentGrid,
  GetFilterColumVNFDesignComponent,
...
const VNFDesignComponentForm: React.FC<Props> = (props) => {
  ...
  const dtoEditResourceState = (state: RootState) =>
    state.vNFDesignComponentEditReducer.LookUpDtoEdit;
  const dtoNewResourceState = (state: RootState) =>
    state.vNFDesignComponentCreateReducer.LookUpDtoCreate;
          ...
          <div className="col-6">
            <div className="form-group">
              <label className="labelForm voda-bold   mb-0 w-100">
                VNF Design Component <span className="red">*</span>
                <input
                  type="text"
...
export default VNFDesignComponentForm;
