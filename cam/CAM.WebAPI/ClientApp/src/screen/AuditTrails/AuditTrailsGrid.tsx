...
import { GetFilterColumAuditTrails } from "../../Redux/Action/AuditTrails/AuditTrailsCommonAction";
...
interface Props {
  ...
  data: AuditTrailsDtoGrid[] | undefined;
  pagination: AuditTrailsQueryObjectGrid | undefined;
  renderGrid: RenderDetail[];
  orphanColor?: boolean;
}

const AuditTrailsGrid: React.FC<Props> = (props) => {
  ...
  const getFiltersData = (state: RootState) =>
    state.AuditTrailsGridReducer.filter;
  ...
  const {
    ...
    isFiltriAttivati,
  } = useFilterTableCrud<AuditTrailsQueryObjectGrid>(
    props.action.Filter,
    GetFilterColumAuditTrails,
    props.pagination
  );
...
export default AuditTrailsGrid;
