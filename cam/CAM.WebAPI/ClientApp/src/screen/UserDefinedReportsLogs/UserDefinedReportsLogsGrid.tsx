...
import { GetFilterColumnUserDefinedReportsLogs } from "../../Redux/Action/UserDefinedReportsLogs/UserDefinedReportsLogsCommonAction";
...
interface Props {
  ...
  data: UserDefinedReportsLogsDtoGrid[] | undefined;
  pagination: UserDefinedReportsLogsQueryObjectGrid | undefined;
  renderGrid: RenderDetail[];
  orphanColor?: boolean;
}

const UserDefinedReportsLogsGrid: React.FC<Props> = (props) => {
  ...
  const getFiltersData = (state: RootState) =>
    state.UserDefinedReportsLogsGridReducer.filter;
  ...
  const {
    ...
    isFiltriAttivati,
  } = useFilterTableCrud<UserDefinedReportsLogsQueryObjectGrid>(
    props.action.Filter,
    GetFilterColumnUserDefinedReportsLogs,
    props.pagination
  );
...
export default UserDefinedReportsLogsGrid;
