...
import { GetFilterColumViaExportSoftware } from "../../Redux/Action/ViaExport/ViaExportSoftwareGridAction";
...
const ViaExportSoftware: React.FC<Props> = (props) => {
  const [data, setData] = useState<ViaExport[] | undefined>([]);
  const getFiltersData = (state: RootState) =>
    state.viaExportSoftwareGridReducer.filter;
  ...
  const {
    ...
    props.action.Filter,
    GetFilterColumViaExportSoftware,
    props.pagination
  );
  ...
  return (
    <div className="listaApparatiContainer mt-3 mx-0 col-12  p-0 mb-3">
        ...
        <table className="table-responsive table-thead-sticky" tabIndex={-1}>
          <thead>
            <tr className="intestazione">
              ...
              <th className=" ">
                <div
                  className="divFilter viaExports customWidth"
...
export default ViaExportSoftware;
