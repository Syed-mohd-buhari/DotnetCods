        ...
        <div className="row">
          ...
          <div className="col-12">
            <Container show={!props.edit || editState == 1}>
              <fieldset className="fieldset p-0">
                <label className="text-bb">Node Description</label>
                <div className="row">
                  <Container show={!props.edit}>
                    <div className="col-6">
                ...
                <fieldset className="fieldset p-0">
                  ...
                  <div className="row">
                    ...
                    <div className="col-12 pr-0 mt-3">
                      <fieldset className="fieldset p-0">
                        <label className="text-bb">Software Details</label>
                        <div className="row">
                          <div className="col-6 labelForm">
                            <label className="labelForm voda-bold w-100 mb-0">
            ...
            <Container show={editState == 3}>
              <div className="col-12 pl-0">
                <fieldset className="fieldset p-0">
                  <label className="text-bb">Patch System Details</label>
                  <div className="row">
            ...
            <div className=" mt-3">
              <fieldset className="fieldset p-0">
                ...
                <div className="row">
                  ...
                  <div className="col-6">
                    <div className="col-12 pr-0 labelForm">
                      <label className="labelForm voda-bold w-100 mb-0">
                        Element Manager
                        <input
                          type="text"
