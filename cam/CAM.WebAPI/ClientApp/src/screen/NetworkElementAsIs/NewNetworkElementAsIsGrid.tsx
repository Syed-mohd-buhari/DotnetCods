...
import { GetFilterColumNewNetworkElementAsIs } from "../../Redux/Action/NetworkElementAsIs/NetworkElementAsIsGridAction";
...
interface Props {
  ...
  data: NetworkElementAsIsDtoGrid[] | undefined;
  pagination: NetworkElementAsIsQueryObjectGrid | undefined;
  renderGrid: RenderDetail[];
  orphanColor?: boolean;
}

let firstIndex, secondIndex, thirdIndex;
const NetworkElementAsIsGrid: React.FC<Props> = (props) => {
  ...
  const getFiltersData = (state: RootState) =>
    state.newnetworkElementAsIsGridReducer.filter;
  ...
  const {
    ...
    isFiltriAttivati,
  } = useFilterTableCrud<NetworkElementAsIsQueryObjectGrid>(
    props.action.Filter,
    GetFilterColumNewNetworkElementAsIs,
    props.pagination
  );
...
export default NetworkElementAsIsGrid;
