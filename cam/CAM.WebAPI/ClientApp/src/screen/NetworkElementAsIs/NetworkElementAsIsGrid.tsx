...
import { GetFilterColumNetworkElementAsIs } from "../../Redux/Action/NetworkElementAsIs/NetworkElementAsIsGridAction";
...
const NetworkElementAsIsGrid: React.FC<Props> = (props) => {
  ...
  const getFiltersData = (state: RootState) =>
    state.networkElementAsIsGridReducer.filter;
  ...
  const {
    ...
    props.action.Filter,
    GetFilterColumNetworkElementAsIs,
    props.pagination
  );
