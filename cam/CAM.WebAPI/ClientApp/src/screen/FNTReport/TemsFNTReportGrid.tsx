...
import { GetFilterColumFNTReport } from "../../Redux/Action/FNTReport/TemsFNTReportGridAction";
...
const TemsFNTReportGrid: React.FC<Props> = (props) => {
  ...
  const getFiltersData = (state: RootState) =>
    state.temsFntReportGridReducer.filter;
...
export default TemsFNTReportGrid;
