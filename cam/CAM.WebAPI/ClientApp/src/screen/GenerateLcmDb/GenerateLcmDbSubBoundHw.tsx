...
import { GetFilterColumReportSubBoundHardware } from "../../Redux/Action/Report/ReportLcmExportGridAction";
...
const LcmExportSubnetworkBoundaryHw: React.FC<Props> = (props) => {
  ...
  const getFiltersData = (state: RootState) =>
    state.reportSubBoundHardwareGridReducer.filter;
  ...
  const {
    ...
    props.action.Filter,
    GetFilterColumReportSubBoundHardware,
    props.pagination
  );
...
export default LcmExportSubnetworkBoundaryHw;
