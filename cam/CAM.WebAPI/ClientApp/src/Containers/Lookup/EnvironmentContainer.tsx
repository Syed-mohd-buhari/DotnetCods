...
import EnvironmentForm from "../../screen/Lookup/Environment/EnvironmentForm";
import EnvironmentGrid from "../../screen/Lookup/Environment/EnvironmentGrid";
import { GetEnvironmentCreateResource } from "../../Redux/Action/LookUp/Environment/EnvironmentCreateAction";
import {
  DeleteDeepEnvironment,
  GetRelatedRecordsEnvironment,
} from "../../Redux/Action/LookUp/Environment/EnvironmentDeleteAction";
import { GetEnvironmentEditResource } from "../../Redux/Action/LookUp/Environment/EnvironmentEditAction";
import {
  GetEnvironmentGrid,
  GetEnvironmentGridALL,
} from "../../Redux/Action/LookUp/Environment/EnvironmentGridAction";
import {
...
const Environment: React.FC<Props> = (props) => {
  ...
  const GridAll = (state: RootState) =>
    state.environmentGridReducer.LookUpGridResultAll;
  ...
  const refresh = () => {
    closeModal();
    GetEnvironmentGrid(query);
  };

  //PAGINAZIONE E RISULTATI FILTRAGGIO
  const { query, setQuery, next, back } = useResourceTableCrud(
    paginationQueryTipologiche,
    isPermesso ? GetEnvironmentGrid : undefined
  );
  ...
  const {
    ...
    GetEnvironmentCreateResource,
    GetEnvironmentEditResource,
    DeleteDeepEnvironment,
    refresh
  );
  ...
  // useEffect(() => {
  //   GetEnvironmentGrid(paginationQueryTipologiche);
  //   GetEnvironmentGridALL();
  // }, []);
  ...
  const onDelete = async (id: number) => {
    const result = await GetRelatedRecordsEnvironment(id);
    if (result.data != null) {
    ...
    >
      ...
      >
        <DialogTitle className="d-flex justify-content-center">
          <div className="col-12">
            <h4 className="mb-0">
              {edit ? " Edit Environment" : "Add Environment"}
            </h4>
      ...
      <div className="headerPage row mx-0 justify-content-between">
        <div className="d-flex flex-row align-items-center">
          <h3 className="voda-bold text-dark">Environment</h3>
        </div>
        <div className="">
          <button
