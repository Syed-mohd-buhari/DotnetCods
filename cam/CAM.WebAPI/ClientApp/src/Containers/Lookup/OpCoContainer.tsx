...
import OpCoForm from "../../screen/Lookup/OpCo/OpCoForm";
import OpCoGrid from "../../screen/Lookup/OpCo/OpCoGrid";
import { GetOpCoCreateResource } from "../../Redux/Action/LookUp/OpCo/OpCoCreateAction";
import {
  DeleteDeepOpCo,
  GetRelatedRecordsOpCo,
} from "../../Redux/Action/LookUp/OpCo/OpCoDeleteAction";
import { GetOpCoEditResource } from "../../Redux/Action/LookUp/OpCo/OpCoEditAction";
import {
  GetOpCoGrid,
  GetOpCoGridALL,
} from "../../Redux/Action/LookUp/OpCo/OpCoGridAction";
import {
...
const OpCo: React.FC<Props> = (props) => {
  const { isPermesso } = useAuth();
  //DTO
  const [data, setData] = useState<TipologicaGridDto[] | undefined>([]);
  const Grid = (state: RootState) => state.opCoGridReducer.LookUpGridResult;
  const GridDto = useSelector(Grid);
  const GridAll = (state: RootState) =>
    state.opCoGridReducer.LookUpGridResultAll;
  ...
  const { query, setQuery, next, back } = useResourceTableCrud(
    ...
    isPermesso ? GetOpCoGrid : undefined
  );
  ...
  // useEffect(() => {
  //   GetOpCoGrid(paginationQueryTipologiche);
  //   GetOpCoGridALL();
  // }, []);
  ...
  const onDelete = async (id: number) => {
    const result = await GetRelatedRecordsOpCo(id);
    if (result.data != null) {
    ...
    >
      ...
      >
        <DialogTitle className="d-flex justify-content-center">
          <div className="col-12">
            <h4 className="mb-0">{edit ? " Edit OpCo" : "Add OpCo"}</h4>
      ...
      <div className="headerPage row mx-0 justify-content-between">
        <div className="d-flex flex-row align-items-center">
          <h3 className="voda-bold text-dark">OpCo</h3>
        </div>
        <div className="">
          <button
