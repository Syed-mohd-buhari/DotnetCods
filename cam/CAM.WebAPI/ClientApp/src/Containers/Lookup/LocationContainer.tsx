...
import LocationForm from "../../screen/Lookup/Location/LocationForm";
import LocationGrid from "../../screen/Lookup/Location/LocationGrid";
import { GetLocationCreateResource } from "../../Redux/Action/LookUp/Location/LocationCreateAction";
import {
  DeleteDeepLocation,
  GetRelatedRecordsLocation,
} from "../../Redux/Action/LookUp/Location/LocationDeleteAction";
import { GetLocationEditResource } from "../../Redux/Action/LookUp/Location/LocationEditAction";
import {
  GetLocationGrid,
  GetLocationGridALL,
...
export let paginationQueryTipologiche: LocationQueryObjectGrid = {
  id: [],
  description: [],
...
const Location: React.FC<Props> = (props) => {
  ...
  const GridAll = (state: RootState) =>
    state.locationGridReducer.LookUpGridResultAll;
  ...
  const refresh = () => {
    closeModal();
    GetLocationGrid(query);
  };

  //PAGINAZIONE E RISULTATI FILTRAGGIO
  const { query, setQuery, next, back } = useResourceTableCrud(
    paginationQueryTipologiche,
    isPermesso ? GetLocationGrid : undefined
  );
  ...
  const {
    ...
    localStateHistory,
    setLocalState,
  } = useOperationTableCrud<LocationDtoGrid, LocationDtoGrid>(
  ...
  const onDelete = async (id: number) => {
    const result = await GetRelatedRecordsLocation(id);
    if (result.data != null) {
    ...
    <div>
      ...
      >
        <DialogTitle className="d-flex justify-content-center">
          <div className="col-12">
            <h4 className="mb-0">{edit ? " Edit Location" : "Add Location"}</h4>
      ...
      <div className="headerPage row mx-0 justify-content-between">
        <div className="d-flex flex-row align-items-center">
          <h3 className="voda-bold text-dark">Location</h3>
        </div>
        <div className="">
          <button
