...
import DriverForm from "../../screen/Lookup/Driver/DriverForm";
import DriverGrid from "../../screen/Lookup/Driver/DriverGrid";
import { GetDriverCreateResource } from "../../Redux/Action/LookUp/Driver/DriverCreateAction";
import {
  DeleteDeepDriver,
  GetRelatedRecordsDriver,
} from "../../Redux/Action/LookUp/Driver/DriverDeleteAction";
import { GetDriverEditResource } from "../../Redux/Action/LookUp/Driver/DriverEditAction";
import {
  GetDriverGrid,
  GetDriverGridALL,
} from "../../Redux/Action/LookUp/Driver/DriverGridAction";
import {
...
const Driver: React.FC<Props> = (props) => {
  ...
  const Grid = (state: RootState) => state.driverGridReducer.LookUpGridResult;
  const GridDto = useSelector(Grid);
  const GridAll = (state: RootState) =>
    state.driverGridReducer.LookUpGridResultAll;
  ...
  const { query, setQuery, next, back } = useResourceTableCrud(
    ...
    isPermesso ? GetDriverGrid : undefined
  );
  ...
  const {
    ...
    GetDriverCreateResource,
    GetDriverEditResource,
    DeleteDeepDriver,
    refresh
  );
  ...
  useEffect(() => {
    GetDriverGrid(paginationQueryTipologiche);
    GetDriverGridALL();
  }, []);
  ...
  const onDelete = async (id: number) => {
    const result = await GetRelatedRecordsDriver(id);
    if (result.data != null) {
    ...
    >
      ...
      <div className="headerPage row mx-0 justify-content-between">
        <div className="d-flex flex-row align-items-center">
          <h3 className="voda-bold text-dark">Driver</h3>
        </div>
        <div className="">
          <button
