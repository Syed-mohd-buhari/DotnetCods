...
namespace CAM.WebAPI.Controllers.Reports.GraphicalReports
{
    ...
    [ApiController]
        ...
        [Authorize]
    #endif
    public class ExodusGraphicalReportController : CamControllerBase
    {
        ...
        private readonly ExodusGraphicalLevel2ReportManager _exodusGraphicalLevel2ReportManager;
        private readonly ExodusGraphicalLevel1ReportManager _exodusGraphicalLevel1ReportManager;
        private DropdownDataServiceManager _dropdownDataServiceManager;

        public ExodusGraphicalReportController(SystemTypeManager systemTypeManager, ICurrentUserService currentUserService, IExportService exportService,
            ...
            DropdownDataServiceManager dropdownDataServiceManager, ExodusGraphicalLevel2ReportManager exodusGraphicalLevel2ReportManager, ExodusGraphicalLevel1ReportManager exodusGraphicalLevel1ReportManager) : base(logger, contextAccessor)
        {
            ...
            _exodusGraphicalLevel2ReportManager = exodusGraphicalLevel2ReportManager;
            _exodusGraphicalLevel1ReportManager = exodusGraphicalLevel1ReportManager;
        ...
        public async Task<ResultDto> GetOpcoWisePercentage([FromBody] ExodusGraphicalReportQueryDto buildFilterDto, bool isPageLoad = false)
        {
            try
            {
                ...
                return await _exodusGraphicalLevel1ReportManager.FindWithCondition(buildFilterDto, isPageLoad);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex);
        ...
        public async Task<ResultDto> GetAllDropdownRecords([FromBody] ExodusGraphicalReportQueryDto buildFilterDto, bool isPageLoad = false)
        {
            try
            {
                ...
                return await _exodusGraphicalLevel1ReportManager.GetAllDropdowns(buildFilterDto, isPageLoad);
        ...
        public async Task<ResultDto> GetPlannedActivityDropDown([FromBody] ExodusGraphicalReportQueryDto buildFilterDto)
        {
            try
            {

                return await _exodusGraphicalLevel2ReportManager.GetPADropdown(buildFilterDto);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex);
        ...
        public async Task<ResultDto> GetPlannedActivity([FromBody] ExodusGraphicalReportQueryDto buildFilterDto)
        {
            try
            {
                if (buildFilterDto.OpcoId == null || (buildFilterDto.OpcoId != null && buildFilterDto.OpcoId.Count == 0))
                ...
                return await _exodusGraphicalLevel2ReportManager.FindWithConditionForPALevelPercentage(buildFilterDto);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex);
        ...
        [HttpPost("GetPlannedActivityForAsset")]
        public async Task<ResultDto> GetPlannedActivityForAsset([FromBody] ExodusGraphicalReportQueryDto buildFilterDto)
        {
            try
            {
                if (buildFilterDto.OpcoId == null || (buildFilterDto.OpcoId != null && buildFilterDto.OpcoId.Count == 0))
                ...
                return await _exodusGraphicalLevel2ReportManager.FindWithConditionForPALevelPercentageForAsset(buildFilterDto);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex);
