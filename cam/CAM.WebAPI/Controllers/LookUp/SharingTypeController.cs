...
namespace CAM.WebAPI.Controllers.LookUp
{
    ...
    [Authorize]
        ...
        [Authorize]
#endif
    public class SharingTypeController : CamControllerBase
    {
        private readonly SharingTypesManager _opCoManager;
        private readonly ICurrentUserService _currentUserService;

        public SharingTypeController(SharingTypesManager opCoManager, ILoggerManager logger, IHttpContextAccessor contextAccessor, ICurrentUserService currentUserService) : base(logger, contextAccessor)
        {
        ...
        [HttpGet]
        public  Task<QueryResultDto<TipologicaGridDto>>  GetSharingType([FromQuery] TipologicaQueryDto opCoFilterDto)
        {
            try
            {
        ...
        public TipologicaGridDto GetCreateResourceSharingType()
        {
            try
            {
                /*_currentUserService.UserInRole("Admin");*/
        ...
        public TipologicaGridDto GetUpdateResourceSharingType(short id)
        {
            try
            {
                /*_currentUserService.UserInRole("Admin");*/
